...
var matrix = [
// The sum of the row is market share now, e.g. Apple 19.1584% of the market 
// The column is comming from other brand
// Apple,    HTC,  Huawei,      LG,   Nokia, Sumsung,    Sony,   Others,
// 0 Apple
[9.6899,  0.8859,  0.0554,  0.4430,  2.5471,  2.4363,  0.5537,  2.5471], /*0 Apple 19.1584*/
// 1 HTC,
[0.1107,  1.8272,       0,  0.4983,  1.1074,  1.0520,  0.2215,  0.4983], /*1 HTC 5.3154*/
// 2 Huawei
[0.0554,  0.2769,  0.2215,  0.2215,  0.3876,  0.8306,  0.0554,  0.3322], /*2 Huawei 2.3811*/
// 3 LG
[0.0554,  0.1107,  0.0554,  1.2182,  1.1628,  0.6645,  0.4983,  1.0520], /*3 LG 4.8173*/
// 4 Nokia
[0.2215,  0.4430,       0,  0.2769, 10.4097,  1.2182,  0.4983,  2.8239], /*4 Nokia 15.8915*/
// Sumsung(5) get
// 1.1628% from apple
//   apple get 9.6899% from Samsung, Samsung lost much for the battle to Apple
// 2.6024% from HTC
//     HTC get 1.0520% from Samsung, Samsung won  the battle to HTC
// 0%      from Huawei, because huawei was most likely 0% at the time
//   Huwei get 0.8306% from Samsung, Samsung lost a little to Huawei
// 1.3843% from LG
//     LG  get 0.6645% from Samsung
// 8.7486% from Nokia
//  Nokia  get 1.2182% from Samsung, Nokia is total looser 
//16.8328% from Samsung itself, mean 16.8328% keep loyal
// 1.7165% from Sony
// 5.5925% from others
[1.1628,  2.6024,       0,  1.3843,  8.7486, 16.8328,  1.7165,  5.5925], /*5 Samsung 38.0399*/
// 6 Sony
[0.0554,  0.4983,       0,  0.3322,  0.4430,  0.8859,  1.7719,  0.4430], /*6 Sony 4.4297*/
// 7 Others
[0.2215,  0.7198,       0,  0.3322,  1.6611,   1.495,  0.1107,  5.4264]  /*7 Other 9.9667*/
];
/*Sums up to exactly 100*/

// why 0.0554%?
// because the total survey got 1846 response back
// so each response weight is 1/1846=0.00054=0.054%
// so the 0.0554% might be 0.054%
